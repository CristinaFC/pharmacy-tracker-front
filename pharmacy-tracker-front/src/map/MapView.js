...
class MapView extends Component {
  ...
  render() {
    ...
    /**const marks =  [
      {"name": "Farmacia A ", "position": [28.073482, -15.452444]},
      {"name": "Farmacia B ", "position": [28.330482, -15.452444]},
    ];*/
    ...
    pharmacies.map((pharmacy) => {
      marks.push({"address" : pharmacy.Address, "position" : [pharmacy.Location.latitude, pharmacy.Location.longitude]});
    });
